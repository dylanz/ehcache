...
Gem::Specification.new do |s|
  s.name = "jruby-ehcache-rails3"
  s.version = Ehcache::VERSION
  s.authors = ["Dylan Stamat", "Jason Voegele"]
  s.summary = "Rails 3 cache store provider using Ehcache or BigMemory"
  s.description = "jruby-ehcache-rails3 a Rails 3 cache store provider that uses Ehcache or BigMemory as its backing store."
